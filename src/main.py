...
parser.add_argument('--source_popular_ratio', type=float, default=0.2, help='Top ratio of source-domain training items treated as popular')
parser.add_argument('--adaptive_pop_dropout', type=bool, default=True, help='Enable Adaptive Popular Dropout in Stage-1 source sequence')
parser.add_argument('--adaptive_pop_dropout_max', type=float, default=0.4, help='Maximum dropout probability for popular items')
parser.add_argument('--adaptive_pop_min_keep', type=int, default=2, help='Minimum number of valid interactions kept in each sequence')
