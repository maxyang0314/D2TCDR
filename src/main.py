...
parser.add_argument('--target_adaptive_pop_dropout', type=int, default=1, choices=[0, 1], help='Enable Target Adaptive Popular Dropout in Stage-2')
parser.add_argument('--target_adaptive_pop_dropout_max', type=float, default=0.4, help='Maximum dropout probability for Target Popular interactions')
parser.add_argument('--target_adaptive_pop_min_keep', type=int, default=2, help='Minimum valid interactions kept after Target Adaptive Popular Dropout')
